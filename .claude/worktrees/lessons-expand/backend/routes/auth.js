 ...
 *
 * DIQQAT: bu bayroq HOSTINGDA (Render) ATAYIN E'TIBORSIZ QOLDIRILADI.
 * Sababi: u yerda konsol — Render loglari, foydalanuvchi ularni ko'ra
 * olmaydi. Bayroq yoqilgan bo'lsa, odam "kod emailingizga yuborildi"
 ...
 * (`RENDER` — Render o'zi qo'yadigan muhit o'zgaruvchisi.)
 *
 * @returns {{ok: true} | {ok: false, status: number, error: string}}
 */
const OTP_CONSOLE_FALLBACK =
  process.env.DEV_OTP_TO_CONSOLE === "true" && !process.env.RENDER;
