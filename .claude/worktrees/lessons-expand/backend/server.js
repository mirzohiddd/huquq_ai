...
const defaultOrigins = [
  ...
  "https://huquq-ai-2gvs.onrender.com", // backendning o'zi
...
mongoose
  ...
  .then(async () => {
    ...
    app.listen(PORT, () => {
      ...
      // ogohlantirish chiqaramiz. Hostingda (Render) bayroq umuman
        ...
        if (process.env.RENDER) {
          console.warn(
            "\n" +
              ...
              "     kodni ololmay boshi berk ko'chaga kiradi). Render\n" +
              "     dashboard → Environment bo'limidan shu o'zgaruvchini\n" +
              "     O'CHIRIB TASHLANG.\n",
          );
        } else {
          console.warn(
