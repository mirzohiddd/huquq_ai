export const translations = {
  uz: {
    ...
    contact_phone: "+998 99 603 66 11",
    contact_email: "toxirovi82@gmail.com",
    ...
    pricing_features_free: [
      ...
      "3 ta dars bo'limiga kirish",
      "Cheklangan amaliy testlar",
      "Reklama ko'rsatiladi",
    ],
    pricing_features_basic: [
      "Kuniga 30 ta AI savoli",
      "Darslarga to'liq kirish",
      "Cheksiz testlar",
      "Test tarixi saqlanadi",
      "AI suhbat tarixi — 7 kun",
    ],
    pricing_features_pro: [
      ...
      "AI suhbat tarixi — 30 kun",
      "Ustuvor (tezkor) AI javoblari",
    ],
    pricing_features_premium: [
      "Kuniga 500 ta AI savoli",
      "Pro'dagi barcha imkoniyatlar",
      "Cheksiz AI suhbat tarixi",
      "Eng tezkor AI javoblari",
      "Yangi funksiyalarga erta kirish",
      "Kelajakdagi premium funksiyalar — qo'shimcha to'lovsiz",
    ],
  ...
  ru: {
    ...
    pricing_features_free: [
      ...
      "Доступ к 3 разделам уроков",
      "Ограниченные практические тесты",
    ...
    pricing_features_basic: [
      ...
      "История AI-чата — 7 дней",
    ],
    pricing_features_pro: [
      "200 AI-вопросов в день",
      "Всё, что есть в Basic",
      "Анализ ошибок AI",
      "Персональные рекомендации по обучению",
      "История AI-чата — 30 дней",
      "Приоритетные (быстрые) ответы AI",
    ],
    pricing_features_premium: [
      "500 AI-вопросов в день",
      "Всё, что есть в Pro",
      "Неограниченная история AI-чата",
      "Самые быстрые ответы AI",
      "Ранний доступ к новым функциям",
      "Будущие премиум-функции — без доплаты",
    ],
