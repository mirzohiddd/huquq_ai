          ...
          <>
            ...
            <footer className={s.inputBar}>
              ...
              <div className={s.inputWrap}>
                ...
                {/* Eslatma: bu tugmaga avval CSS modulidagi mavjud
                    BO'LMAGAN sinfga havola berilgan edi (qiymat
                    `undefined` bo'lardi). Ko'rinish inline uslublar
                    bilan berilgani uchun vizual muammo yo'q edi —
                    o'lik havola olib tashlandi. */}
                <button
                  type="button"
