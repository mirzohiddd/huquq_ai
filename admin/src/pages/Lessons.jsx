...
/* ── DARS MODULLARI ──────────────────────────────────────────────
   Foydalanuvchi sahifasida darslar shu modullar bo'yicha guruhlanadi
   va filtrlanadi (`frontend/src/pages/lessonModules.js`).

   ⚠️ `id` lar ikkala joyda BIR XIL bo'lishi shart — bazada aynan shu
   qiymat saqlanadi (`Lesson.category`). Nom bu yerda o'zbekcha
   yozilgan, chunki admin paneli faqat o'zbek tilida.

   Ro'yxat ataylab nusxalangan: admin alohida ilova va u frontend
   kodini import qila olmaydi. Yangi modul qo'shilsa ikkala joyda
   ham yangilash kerak. */
const LESSON_MODULES = [
  { id: "constitution", name: "Konstitutsiya va davlat" },
  { id: "civil", name: "Fuqarolik huquqi" },
  { id: "contracts", name: "Shartnomalar" },
  { id: "family", name: "Oila huquqi" },
  { id: "inheritance", name: "Meros huquqi" },
  { id: "labor", name: "Mehnat huquqi" },
  { id: "housing", name: "Uy-joy va yer" },
  { id: "consumer", name: "Iste'molchi huquqlari" },
  { id: "tax", name: "Soliq va tadbirkorlik" },
  { id: "administrative", name: "Ma'muriy huquq" },
  { id: "criminal", name: "Jinoyat huquqi" },
  { id: "process", name: "Sud va himoya" },
  { id: "special", name: "Maxsus sohalar" },
];
    ...
    <Modal onClose={onClose}>
      ...
      <div className={ms.body} style={{ maxHeight: "70vh", overflowY: "auto" }}>
        ...
        <div className={es.inlineRow}>
          {/* Modul — foydalanuvchi sahifasida darslar shu bo'yicha
              guruhlanadi va filtrlanadi. Bo'sh qoldirilsa dars
              "Boshqa mavzular" guruhida ko'rinadi (yo'qolib
              qolmaydi). */}
          <div className={ms.field}>
            <label className={ms.fieldLabel}>Modul (bo'lim)</label>
            <select
              className={ms.input}
              value={category}
