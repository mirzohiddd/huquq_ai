  ...
  return (
    ...
    <Routes>
      <Route element={<SiteLayout />}>
        ...
        {/* Eski sahifa manzillari Home'dagi tegishli bo'limga yo'naltiriladi.
            `/about` ham shular qatorida: "Biz haqimizda" qisqa muddat
            mustaqil sahifa bo'lgan edi, keyin yana Landing Page bo'limiga
            qaytarildi. Yo'naltirish SAQLANADI — tashqi havolalar va
            qidiruv tizimlari indeksidagi `/about` buzilmasligi uchun. */}
