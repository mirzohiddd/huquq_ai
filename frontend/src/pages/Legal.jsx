...
import { graph, breadcrumbSchema } from "../seo/schema";
...
function LegalPage({ title, seoTitle, sections, current, children }) {
  ...
  /* SEO: "Bosh sahifa › Foydalanish shartlari" — Google qidiruv
     natijasida sahifa yo'lini ko'rsatadi. Bosh sahifada bunday sxema
     ATAYLAB yo'q: bitta bandli yo'l hech qanday ma'lumot bermaydi. */
