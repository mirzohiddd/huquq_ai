...
function GoogleButton({ labelKey, onCredential, disabled }) {
  ...
  useEffect(() => {
    ...
    function renderRealButton() {
      ...
      // ⚠️ Eni QAT'IY 320px edi — tor telefonda (≤360px) karta ichida
      // bu Google tugmasini chetga chiqarib yubordi (o'lchangan: 320px
      // ekranda konteyner 249px, tugma esa 320px). Endi eni haqiqiy
      // konteynerdan olinadi. Google 200-400px oralig'ini qabul qiladi,
      // shuning uchun qiymat shu oraliqqa siqiladi.
